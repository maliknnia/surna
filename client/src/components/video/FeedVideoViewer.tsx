...
const showcaseAuthor = (index: 0 | 1) => {
  const a = SHOWCASE_ATHLETES[index];
  return {
    id: index === 0 ? "u1" : "u2",
...
export const DEMO_REELS: VideoPost[] = withDemoThumbs([
  {
    id: "dv1",
    content: "Morning pool session — smooth catch, relaxed kick, race-pace splits 🏊",
    sport: "Swimming",
    sportEmoji: "🏊",
    format: "reel",
    likesCount: 1247,
    ...
    context: "For You",
    entityType: "coach",
    entityId: "demo-coach-aisha",
    role: "coach",
    location: "Atlanta",
    distance: "2.1 km",
    author: showcaseAuthor(0),
  },
  {
    id: "dv2",
    content: "Serve rhythm clinic — toss height and shoulder turn in slow motion 🎾",
    sport: "Tennis",
    sportEmoji: "🎾",
    format: "reel",
    likesCount: 892,
    ...
    context: "For You",
    entityType: "coach",
    entityId: "demo-coach-elena",
    role: "coach",
    location: "New York",
    distance: "5 km",
    author: showcaseAuthor(1),
  },
]);
...
export const DEMO_FEED_VIDEOS: VideoPost[] = withDemoThumbs([
  {
    id: "fv1",
    content: "Freestyle technique breakdown — catch, rotation, and breathing patterns",
    sport: "Swimming",
    sportEmoji: "🏊",
    format: "video",
    durationSec: 754,
  ...
  {
    id: "fv2",
    content: "Match-play footwork — first-step explosiveness and recovery steps",
    sport: "Tennis",
    sportEmoji: "🎾",
    format: "video",
    durationSec: 680,
