...
export const DEMO_PLACES: DemoPlace[] = [
  {
    ...
    reviewsCount: 68,
    averageRating: "4.9",
    /** Facility thumb vs wide atmosphere cover (blur cards need both). */
    profileImageUrl: IMG("1576013551627-0cc020b9e4d2", 400, 400),
  ...
  },
  {
    ...
    reviewsCount: 54,
    averageRating: "4.8",
    profileImageUrl: IMG("1554068865-24ece043a6b2", 400, 400),
  ...
  },
  {
    ...
    reviewsCount: 39,
    averageRating: "4.7",
    profileImageUrl: IMG("1483721310020-03333e577078", 400, 400),
