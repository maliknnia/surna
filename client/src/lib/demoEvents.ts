...
export const DEMO_EVENTS: DemoEvent[] = [
  ...
  {
    id: "demo-ev-tempo-tuesday",
    title: "Tempo Tuesday 8K",
    description: "Steady threshold pace · cool-down strides.",
    ...
    creator_username: "jordan_run",
    creator_avatar: athlete("jordan_run")?.profileImageUrl,
    cover_url: athlete("jordan_run")?.coverImageUrl,
    isDemo: true,
  },
  {
    id: "demo-ev-trail-ridge",
    title: "Ridge Trail Long Run",
    description: "Easy conversational pace · scenic loops.",
    location: "Diamond Hill · Galway",
    sport: "Running",
    starts_at: hoursFromNow(40),
    going_count: 9,
    interested_count: 4,
    capacity: 16,
    creator_first_name: "Sofia",
    creator_username: "sofia_trail",
    creator_avatar: athlete("sofia_trail")?.profileImageUrl,
    cover_url: athlete("sofia_trail")?.coverImageUrl,
    isDemo: true,
  },
];
